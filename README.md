...
Experiments are carried out by the notebook files. Figure 1, 2 and 5 can be reproduced in main fig.ipynb. Figure 6 can be reproduced in different data size.ipynb. Figure 7 can be reproduced in different dimension fig sine.ipynb.
Algorithms and all other functions are contained in the folder lib.
